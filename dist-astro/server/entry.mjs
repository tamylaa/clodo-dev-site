...
import { manifest } from './manifest_BC_POcpy.mjs';

const serverIslandMap = new Map();;

const _page0 = () => import('./pages/about.astro.mjs');
const _page1 = () => import('./pages/docs.astro.mjs');
const _page2 = () => import('./pages/migrate.astro.mjs');
const _page3 = () => import('./pages/pricing.astro.mjs');
const _page4 = () => import('./pages/product.astro.mjs');
const _page5 = () => import('./pages/index.astro.mjs');
const pageMap = new Map([
    ["src/pages/about.astro", _page0],
    ["src/pages/docs.astro", _page1],
    ["src/pages/migrate.astro", _page2],
    ["src/pages/pricing.astro", _page3],
    ["src/pages/product.astro", _page4],
