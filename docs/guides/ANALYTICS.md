...
# Auto-discovery mode (recommended)
   node tools/validate-cloudflare-analytics.js YOUR_API_TOKEN# Or specify domain if multiple zones
   node tools/validate-cloudflare-analytics.js YOUR_API_TOKEN clodo.dev
```
