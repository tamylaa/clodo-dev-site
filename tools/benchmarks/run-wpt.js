#!/usr/bin/env node
// Run WebPageTest tests for a list of URLs and locations and save JSON results.
// Usage: node run-wpt.js --apiKey $WPT_API_KEY --urls https://example.com --locations Dulles:Chrome,ec2-us-west-2:Chrome
