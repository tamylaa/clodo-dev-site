  ...
  try {
    ...
    for (const file of fileList) {
      ...
      if (file.includes(path.join('public', 'blog')) || file.includes(path.join('dist', 'blog'))) {
        ...
        content = content.replace(/https:\/\/clodo\.dev\/blog\/([a-z0-9-]+)\.html/gi, 'https://www.clodo.dev/blog/$1');
        content = content.replace(/https:\/\/www\.clodo\.dev\/blog\/([a-z0-9-]+)\.html/gi, 'https://www.clodo.dev/blog/$1');
      }
