...
const BASE_URL = process.argv[2] || ANALYZER_CONFIG.urls.production;

// Determine if we're in development mode
const IS_DEVELOPMENT = isDevelopment(BASE_URL);
const PRODUCTION_DOMAIN = ANALYZER_CONFIG.urls.production;
...
async function checkPage(browser, url, filePath) {
    ...
    try {
        const response = await page.goto(url, { waitUntil: 'domcontentloaded', timeout: ANALYZER_CONFIG.timeouts.pageLoad });
